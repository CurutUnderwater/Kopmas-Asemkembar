          ...
          <div>
            <div class="profile-timeline stagger">
              <div class="timeline-item">
                ...
                <h4>Pemanenan</h4>
                <p>Pakcoy dipanen setelah 90 hari masa tanam. Pemanenan dilakukan di pagi hari untuk menjaga kesegaran dan kualitas daun.</p>
              </div>
              <div class="timeline-item">
      ...
      <div class="container">
        ...
        <div class="grid grid-4 stagger">
          ${(() => {
            ...
            if (members.length === 0) {
              return '<p class="text-center text-light" style="grid-column: 1/-1;">Belum ada data anggota.</p>';
            }
            return members.map(m => `
              <div class="card text-center">
                <div class="card-body">
                  ${m.image 
                    ? `<img src="${m.image}" alt="${m.name}" style="width:80px; height:80px; border-radius:50%; object-fit:cover; margin-bottom: var(--space-md);">` 
