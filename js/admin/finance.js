...
function renderAdminReports() {
  ...
  return `
    <div class="card" style="padding: var(--space-lg); margin-bottom: var(--space-xl); background: linear-gradient(135deg, rgba(82,183,136,0.05), rgba(45,106,79,0.08));">
      <div class="flex items-center justify-between" style="flex-wrap:wrap; gap: var(--space-md);">
        <div>
          <h4 style="margin-bottom: 4px;">📋 Laporan Keuangan Formal</h4>
          <p class="text-light" style="font-size: var(--fs-sm);">Laporan standar akuntansi: Laba Rugi, Posisi Keuangan, Perubahan Ekuitas, dan Arus Kas</p>
        </div>
        <a href="#/laporan" target="_blank" class="btn btn-ghost btn-sm">🌐 Lihat di Halaman Publik →</a>
      </div>
    </div>

    <!-- Period Filter -->
    <div class="report-filter-bar" style="margin-bottom: var(--space-lg);">
      ...
      <div class="flex gap-sm">
        <button class="btn btn-primary btn-sm" onclick="downloadReportPDF()">📄 PDF</button>
        <button class="btn btn-secondary btn-sm" onclick="downloadReportExcel()">📊 Excel</button>
      </div>
    </div>
